...
<div style="display:flex;"><iframe width="480" height="480" src="https://mult.dev/embed/HizMyMEWNO" title="Mult.dev Player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen scrolling="no"></iframe></div>

# Resolutions for Next Year

N﻿ext year I plan to <style="display:flex;>
